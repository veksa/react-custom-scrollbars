...
export default class Scrollbars extends Component {
    ...
    getValues() {
        ...
        return {
            ...
            scrollLeft,
            scrollTop,
            scrollWidth: fixMacOsContentWidth(scrollWidth, rootId),
            scrollHeight,
            clientWidth: fixMacOsContentWidth(clientWidth, rootId),
            clientHeight
        };
    }
    ...
    addListeners() {
        ...
        if (!getScrollbarWidth(true, rootId)) return;
    ...
    _update(callback) {
        ...
        if (getScrollbarWidth(true, rootId)) {
    ...
    render() {
        ...
        const scrollbarWidth = getScrollbarWidth(true, rootId);
        const scrollbarWidthVertical = getScrollbarWidth(hasVerticalScroll);
